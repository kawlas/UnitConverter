...
const faqItems = [
  { question: "Which conversions are supported?", answer: "Fourteen standard unit categories, plus dedicated height, BMI and ingredient-aware grams-to-cups calculators." },
